    ...
    <div class="container inner-frame">
        <div class="row main-frame">
            ...
            <div class="col-sm-7 frame-middle">
                <div class="title-box">我参与的活动</div>
                <div class="chart-box">
                    @if(!count($activities))
                        <div class="well">
                            <label>您暂时没有加入任何活动……</label>
                        </div>
                    @endif
                        ...
                        @foreach($activities as $activity)
                            <div class="well">
                                ...
                                <span class="activity-btn-list">
                                    <label class="activity-btn"><a href="/activity/detail_joined/{{$activity->id}}">详情</a></label>
                                    <label>|</label>
                                    <label class="activity-btn"><a href="/activity/drop/{{$activity->id}}">退出活动</a></label>
                                </span>
                            </div>
                        @endforeach
                    @endif
