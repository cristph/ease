    ...
    <div class="container inner-frame">
        <div class="row main-frame">
            ...
            <div class="col-sm-7 frame-middle">
                <div class="title-box">我发布的活动</div>
                <div class="chart-box">
                    @if(!count($activities))
                        <div class="well">
                            <label>您暂时没有发布任何活动……</label>
                        </div>
                    @endif
                        ...
                        @foreach($activities as $activity)
                            <div class="well">
                                ...
                                <span class="activity-btn-list">
                                    <label class="activity-btn"><a href="/activity/detail_posted/{{$activity->id}}">详情</a></label>
                                    <label>|</label>
                                    <label class="activity-btn"><a href="/activity/edit/{{$activity->id}}">编辑</a></label>
                                    <label>|</label>
                                    <label class="activity-btn"><a href="/activity/delete/{{$activity->id}}">删除</a></label>
                                </span>
                            </div>
                        @endforeach
                    @endif
