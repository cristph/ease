    ...
    <div class="container inner-frame">
        <div class="row main-frame">
            ...
            <div class="col-sm-7 frame-middle">
                <div class="title-box">发布活动</div>
                <div class="chart-box">
                    <form id="postActivity" class="postActivity" novalidate="novalidate" method="post" action="/activity/formPost">
                        <div class="form-group">
                            <label>活动名称</label>
                            <input type="text" class="form-control activity-name" name="theme" id="activity-name">
                        </div>
                        <div class="form-group">
                            <label>活动介绍</label>
                            <textArea class="form-control activity-intro" rows="5" name="content"></textArea>
                        </div>
                        <div class="form-group">
                            <label>活动时间</label></br>
                            <input type="date" class="form-control activity-start" name="startTime" id="activity-start">
                            至
                            <input type="date" class="form-control activity-end" name="endTime" id="activity-end">
                        </div>
                        <input type="submit" value="创建活动" class="button button-primary button-rounded">
